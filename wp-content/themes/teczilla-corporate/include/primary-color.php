<?php 
function teczilla_corporate_inline_css(){
...
$teczilla_theme_color_scheme = get_theme_mod('teczilla_theme_color_scheme','#e8151b');               
...
$teczilla_custom_css      .= '.blog-wrap,.comment-respond .comment-form-comment textarea,
.comment-respond .comment-form-author input,.comment-respond .comment-form-email input,
.comment-respond .comment-form-url input
       {
        border: 2px solid '. esc_attr( $teczilla_theme_color_scheme) . ' !important}';
...
add_action( 'wp_enqueue_scripts', 'teczilla_corporate_inline_css',20 );
                              ...
                              <h2 class="banner-heading">
                                <?php if ( is_archive() ) {
                                 ...
                                 elseif(is_search()){
                                  ...
                                  echo  esc_html__('Search Results For ', 'teczilla-corporate') . ' " ' . get_search_query() . ' "';

                                 }elseif ( is_404() ) {
                                  echo  esc_html__('Nothing Found ', 'teczilla-corporate');
                                 }
                                 else{
